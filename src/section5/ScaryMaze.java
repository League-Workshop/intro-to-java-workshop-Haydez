...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		AudioClip scare = JApplet.newAudioClip(getClass().getResource("title.wav"));
		scare.loop();
		scare.play();
		maze = ImageIO.read(getClass().getResource("SCARRYYYY MAZE.jpg"));
	...
	if (mouseColor == wallColor) {
		...
		int endColor = -16255992;
				
				if (mouseColor == endColor) {
					showScaryImage("you did a do.png");
	...
	private void scare() {
		...
		AudioClip scare = JApplet.newAudioClip(getClass().getResource("Jumpscare.wav"));
		scare.loop();
		...
		showScaryImage("real scarry shtuff.jpg");
	}
